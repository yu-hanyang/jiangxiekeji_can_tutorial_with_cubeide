...
CAN_TxHeaderTypeDef TxMsgArray[7] = {
		{ .StdId = 0x123, .ExtId = 0x00000000, .IDE =CAN_ID_STD, .RTR = CAN_RTR_DATA, .DLC = 4 },
		{ .StdId = 0x234, .ExtId = 0x00000000, .IDE =CAN_ID_STD, .RTR = CAN_RTR_REMOTE, .DLC = 4 },
		{ .StdId = 0x345, .ExtId = 0x00000000, .IDE =CAN_ID_STD, .RTR = CAN_RTR_DATA, .DLC = 4 },
		{ .StdId = 0x456, .ExtId = 0x00000000, .IDE =CAN_ID_STD, .RTR = CAN_RTR_DATA, .DLC = 4 },
		{ .StdId = 0x567, .ExtId = 0x00000000, .IDE =CAN_ID_STD, .RTR = CAN_RTR_DATA, .DLC = 4 },
		{ .StdId = 0x678, .ExtId = 0x00000000, .IDE =CAN_ID_STD, .RTR = CAN_RTR_DATA, .DLC = 4 },
		{0}
};
